...
tribble(
  ...
  "Levantado de pizarra", 163, 136, 10,
  "Enfoscado hastial", 24, 6, 50,
  "Canalones y bajantes", 44, 49, 35,
  "Baberos", 24, 19, 25,
  # "Rastrel primario", 139, 136, 12,
  "Telas asfálticas", 139, 136, 22,
  "Rastrel secundario", 139, 136, 21,
  "Teja plana", 139, 136, 45,
  "Enfoscado chimenea", 1, 1, 250,
  "Premarco de ventana", 1, 1, 400,
  "Chapas perimetrales", 55, 65, 18,
  ...
  "Pilares 3.0", 2, 2, 200,
  "Chapón", 2, 2, 170,
  "Chapa colaborante", 24.8, 28, 85,
  "Fibrocemento en aleros", 15.5, round((6.15 * 2 + 4.55) * 0.3, 1), 35,
  "Monocapa en aleros", 15.5, round((6.15 * 2 + 4.55) * 0.3, 1), 32) |>
