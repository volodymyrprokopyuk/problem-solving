...
```{r pendiente-pago}
total_sin_iva <- 32657.50 - 1715.00 # Canalones y bajantes
total_con_iva <- total_sin_iva * 1.1 - 51.00 - 41.10 # Tornillos 50, Sikaflex
pendiente_pago <- total_con_iva - sum(total_pagado$importe)
```

Total sin IVA (-1715.00 canalones): `r total_sin_iva`

Total con 10% IVA (-51.00 - 41.10 tornillos 50 y Sikaflex): `r total_con_iva`

Pendiente a pagar (certificado de contenedor): `r pendiente_pago`
