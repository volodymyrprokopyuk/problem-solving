...
plot + geom_point()
plot + geom_violin() +
  stat_summary(fun = median, geom = "point", shape = 22, size = 3, fill = "yellow")
plot + geom_boxplot() +
...
data |>
  ggplot(aes(x = total_elapsed_time)) +
  geom_histogram(aes(y = stat(density)), bins = 30, color = "gray50", fill = "khaki1") +
  geom_density(adjust = 0.7, color = "gray50", fill = "greenyellow", alpha = 0.2) +
...
data |>
  ggplot(aes(x = module_elapsed_time, fill = module_name)) +
  geom_histogram(aes(y = stat(density)), bins = 30, color = "gray50") +
  geom_density(adjust = 0.7, color = "gray50", fill = "yellow", alpha = 0.2) +
  facet_grid(module_name ~ .)
```
